...
const CATEGORY_UNSPLASH: Record<string, string> = {
  ...
  WESTERN_FOOD:  "photo-1544025162-d76694265947",
...
async function main() {
  ...
  // Create DiagnosisReport records for listings with hasDiagnosisBadge
  if (createdListings.length >= 2) {
    ...
    for (const data of diagnosisData) {
    ...
    console.log("  DiagnosisReport: 2 records created");
  }
