      ...
      <div className="mb-6 rounded-lg bg-amber-50 border border-amber-200 p-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex-shrink-0 px-4 py-2 text-sm font-medium text-amber-700 bg-white border border-amber-300 rounded-lg hover:bg-amber-100 transition-colors"
          >
            가이드 보기
          </button>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        {/* Footer */}
        <div className="sticky bottom-0 bg-white border-t border-line px-6 py-4">
          <button
            onClick={onClose}
