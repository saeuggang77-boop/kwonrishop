...
export default function IndustryRevenueSection({
  ...
  const getSummaryMessage = () => {
    ...
    return (
      <div className={`p-4 rounded-lg ${isHigher ? 'bg-green-50 border border-green-200' : 'bg-green-50 border border-green-200'}`}>
        <p className={`text-sm ${isHigher ? 'text-green-800' : 'text-green-800'}`}>
  ...
  if (error || !data) {
    return (
      <div className="bg-red-50 border border-red-200 rounded-xl p-6 text-center">
        <p className="text-red-600">업종 매출 정보를 불러올 수 없습니다</p>
      </div>
    );
  }
      ...
      <div className="bg-gray-50 rounded-xl p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="w-full bg-gray-200 rounded h-8 overflow-hidden">
              <div
                className="h-full bg-gray-400 transition-all duration-500 flex items-center justify-end pr-2"
