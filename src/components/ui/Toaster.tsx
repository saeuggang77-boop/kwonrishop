...
export default function Toaster() {
  ...
  return (
    <div className="fixed top-4 left-4 right-4 mx-auto z-[9999] flex flex-col gap-2 max-w-sm w-auto pointer-events-none sm:left-auto sm:right-4 sm:mx-0 sm:w-full">
      {toasts.map((t) => (
        <div
          key={t.id}
