...
export default function LockedSection({
  ...
  return (
    <div className={`relative overflow-hidden rounded-xl ${className}`}>
      ...
      <div className="absolute inset-0 bg-white/85 backdrop-blur-sm flex flex-col items-center justify-center gap-3 p-4 rounded-xl">
        ...
        <p className="text-xs text-gray-400">3초만에 가입 완료</p>
      </div>
    </div>
  );
}
