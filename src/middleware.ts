  ...
  if (isProduction) {
    response.headers.set(
      ...
      [
        ...
        "connect-src 'self' https://*.tosspayments.com https://*.kakao.com https://*.pusher.com wss://*.pusher.com https://*.googleapis.com https://vitals.vercel-insights.com https://api.solapi.com https://apis.data.go.kr https://api.odcloud.kr https://franchise.ftc.go.kr",
        "frame-src 'self' https://*.tosspayments.com https://nid.naver.com https://kauth.kakao.com https://*.daumcdn.net https://*.daum.net https://*.kakao.com",
      ].join("; ")
    );
  }
