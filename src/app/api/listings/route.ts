    ...
    if (sort === "rotation") {
      ...
      if (!cursor) {
        ...
        const rotationSelect = {
          ...
          goodwillPremium: true, facilityPremium: true, floorPremium: true,
  ...
  try {
    ...
    const listing = await prisma.listing.create({
      data: {
        ...
        goodwillPremium: parsed.goodwillPremium ?? null,
        goodwillPremiumDesc: parsed.goodwillPremiumDesc ?? null,
        facilityPremium: parsed.facilityPremium ?? null,
        facilityPremiumDesc: parsed.facilityPremiumDesc ?? null,
        floorPremium: parsed.floorPremium ?? null,
        floorPremiumDesc: parsed.floorPremiumDesc ?? null,
