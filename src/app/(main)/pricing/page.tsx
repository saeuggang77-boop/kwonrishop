        ...
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              <p className="font-semibold text-red-800 dark:text-red-300 mb-1">결제 전 환불 정책을 꼭 확인해 주세요</p>
              <ul className="text-red-700 dark:text-red-400 space-y-0.5 list-disc list-inside">
