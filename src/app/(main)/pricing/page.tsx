          ...
          <section>
            ...
            <div className="mt-6 grid gap-5 md:grid-cols-3">
              ...
              <div className="flex flex-col rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <Link href="/my/ads" className="mt-5 block w-full rounded-lg bg-blue-600 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-700 active:scale-[0.97]">
                  구매하기
                </Link>
              </div>
              ...
              <div className="relative flex flex-col rounded-2xl border-2 border-red-300 bg-white p-5 shadow-md">
                ...
                <Link href="/my/ads" className="mt-5 block w-full rounded-lg bg-red-600 py-2.5 text-center text-sm font-medium text-white hover:bg-red-700 active:scale-[0.97]">
                  구매하기
                </Link>
              </div>
              ...
              <div className="flex flex-col rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <Link href="/my/ads" className="mt-5 block w-full rounded-lg bg-green-600 py-2.5 text-center text-sm font-medium text-white hover:bg-green-700 active:scale-[0.97]">
                  구매하기
                </Link>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              <div className="rounded-xl border border-gray-200 bg-white p-4">
                <h3 className="text-xs font-bold text-gray-600">무료 공개</h3>
              ...
              <div className="rounded-xl border-2 border-teal-200 bg-teal-50/50 p-4">
                <h3 className="text-xs font-bold text-teal-700">유료 열람</h3>
                <ul className="mt-2.5 space-y-1.5">
          ...
          <section>
            ...
            <div className="mt-4 space-y-3">
              {[
                ...
                { q: "무료로 볼 수 있는 정보는?", a: "매물 사진, 가격정보(보증금/월세/권리금), 기본 매물정보, 월매출/월수익 숫자, 투자회수 기간, 주변시세 비교, 위치정보 등은 모두 무료입니다." },
              ].map((item) => (
