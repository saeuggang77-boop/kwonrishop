...
export default function EquipmentEditPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">집기 수정</h1>
        <p className="text-gray-600">등록한 집기 정보를 수정합니다</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-3">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="flex-1 py-3 bg-green-700 text-white rounded-xl font-medium hover:bg-green-600 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
          >
