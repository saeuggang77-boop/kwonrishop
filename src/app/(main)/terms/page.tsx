      ...
      <div className="prose prose-sm max-w-none space-y-8 text-gray-700">
        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-2">
            ...
            <li>
              사이트에서 제공하는 사업자인증 서비스는 국세청 공개 데이터를 기반으로 사업자등록번호의 유효성(폐업 여부)만을 확인하는 서비스이며, 해당 사업자와 이용자의 동일성(본인 여부)을 보증하지 않습니다.
            </li>
            <li>
              집기장터를 통한 중고 물품 거래는 판매자와 구매자 간 직접 거래이며, 물품의 상태, 성능, 하자 등에 대한 책임은 거래 당사자에게 있습니다. 회사는 거래 물품에 대한 품질 보증을 하지 않습니다.
            </li>
          </ol>
        </section>
          ...
          <ol className="list-decimal list-inside space-y-2">
            ...
            <li>
              ...
              <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                ...
                <li>
                  광고 노출 후 매물의 계약·판매·삭제 등 회원 사정으로 광고를 조기 종료하는 경우: 환불 불가
                </li>
                <li>
        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-2">
            ...
            <li>
              회사는 사업자인증 서비스를 통해 확인된 사업자등록번호의 도용, 위조 등으로 인한 피해에 대하여 책임을 지지 않습니다. 사업자인증은 등록번호의 유효성 확인 서비스일 뿐이며, 거래 상대방의 신원 보증이 아닙니다.
            </li>
            <li>
              회사는 집기장터 등 회원 간 중고 물품 직거래에서 발생하는 사기, 분쟁, 물품 하자 등에 대하여 책임을 지지 않습니다. 회원은 거래 전 물품을 직접 확인하고, 사기 피해 발생 시 경찰청(112) 또는 사이버수사대에 신고하여야 합니다.
            </li>
          </ol>
        </section>
