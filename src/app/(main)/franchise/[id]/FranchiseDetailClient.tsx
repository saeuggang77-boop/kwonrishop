    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
        <div className="flex items-start gap-4">
          <div className="w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold text-2xl shrink-0">{brand.brandName.charAt(0)}</div>
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              ...
              {brand.tier && <span className={`px-2 py-1 rounded-full text-xs font-medium ${brand.tier === "GOLD" ? "bg-yellow-100 text-yellow-800" : brand.tier === "SILVER" ? "bg-gray-100 text-gray-800" : "bg-orange-100 text-orange-800"}`}>{brand.tier}</span>}
            </div>
