      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="flex gap-3">
          ...
          <button
            type="submit"
            disabled={saving}
            className="flex-1 py-3 bg-green-700 text-white rounded-xl font-medium hover:bg-green-600 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
          >
            {saving ? "저장 중..." : "저장"}
          </button>
        </div>
