  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">매물 통계</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-gray-500">총 조회수</span>
            <svg className="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
            </svg>
          </div>
          <p className="text-3xl font-bold text-gray-900">{data.listing.viewCount.toLocaleString()}</p>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-gray-500">총 관심 수</span>
            <svg className="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
            </svg>
          </div>
          <p className="text-3xl font-bold text-gray-900">{data.listing.favoriteCount.toLocaleString()}</p>
          <p className="text-xs text-gray-400 mt-1">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-gray-500">채팅 문의 수</span>
            <svg className="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
            </svg>
          </div>
          <p className="text-3xl font-bold text-gray-900">{data.chatCount.toLocaleString()}</p>
          <p className="text-xs text-gray-400 mt-1">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 mb-6">
        <h2 className="font-bold text-gray-900 mb-3">매물 정보</h2>
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div>
            <span className="text-gray-500">경과일</span>
            <p className="font-medium text-gray-900 mt-1">
          ...
          <div>
            ...
            <p className="font-medium text-gray-900 mt-1">
              <span className={`inline-block px-2 py-1 rounded text-xs ${
                data.listing.status === "ACTIVE" ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-700"
              }`}>
                {statusLabel}
              </span>
            </p>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 mb-6">
        ...
        <div className="space-y-3">
          {[
            { label: "조회", value: data.listing.viewCount, color: "bg-green-500", pct: 100 },
      ...
      {/* 최근 관심 추가 이력 */}
      <div className="bg-white border border-gray-200 rounded-xl p-5">
        <h2 className="font-bold text-gray-900 mb-3">최근 관심 추가 이력</h2>
            ...
            {data.recentFavorites.map((fav, idx) => (
              <div key={idx} className="flex items-center justify-between py-2 border-b border-line last:border-0">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-gray-700">{fav.userName}</span>
                </div>
