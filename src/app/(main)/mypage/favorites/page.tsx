  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex gap-1 mb-6 bg-gray-100 rounded-lg p-1 max-w-xs">
        ...
        >
          매물 <span className={activeTab === "listing" ? "text-green-700" : "text-gray-400"}>{listings.length}</span>
        </button>
        <button
        ...
        >
          집기 <span className={activeTab === "equipment" ? "text-green-700" : "text-gray-400"}>{equipLoaded ? equipment.length : "·"}</span>
        </button>
      </div>
