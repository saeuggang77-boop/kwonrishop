  ...
  return (
    <div className="max-w-md mx-auto px-4 py-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">차단 관리</h1>
      </div>
      ...
      {blockedUsers.length === 0 ? (
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">차단한 사용자가 없습니다.</p>
        </div>
      ) : (
          ...
          {blockedUsers.map((block) => (
            <div key={block.id} className="flex items-center justify-between px-5 py-4">
              ...
              <button
                ...
                className="px-3 py-1.5 text-xs font-medium text-red-600 dark:text-red-400 border border-red-200 dark:border-red-800 rounded-lg hover:bg-red-50 dark:hover:bg-red-950 disabled:opacity-50"
              >
